...
$select = "SELECT * FROM service_order where progress < 100";
  ...
  <div class="container" style="margin-top: 5%;">
    <table class="table table-dark table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                aria-valuenow="<?= $selects['progress'] ?>" aria-valuemin="0" aria-valuemax="100">
          ...
          <td>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
              data-bs-target="#exampleModal<?= $selects['id'] ?>">
              Update Progress
            </button>
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModal<?= $selects['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
              ...
              <form action="" method="post">
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    <input name="progress" type="number" class="form-control" value="<?= $selects['progress'] ?>"
