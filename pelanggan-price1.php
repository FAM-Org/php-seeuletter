      ...
      <table class="table" style="color: white;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><button class="btn btn-primary" id="submit" data-bs-toggle="modal"
                data-bs-target="#modalbeli<?= $selects['id'] ?>">Beli</button></td>
          </tr>
          <div class="modal fade" id="modalbeli<?= $selects['id'] ?>" tabindex="-1" aria-labelledby="modalbeli"
            aria-hidden="true">
                  ...
                  <form action="" method="post">
                    ...
                    <fieldset>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" id="harga" name="harga" value="harga X quantity" class="form-control"
                          readonly>
                      </div>
                    </fieldset>
