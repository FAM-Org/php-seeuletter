...
<body style="background-image: url(ballons.jpg);background-size:cover;">
        ...
        <div class="col">
          <div class="card" style="width: 17rem;">
            ...
            <div class="card-body">
              ...
              <a class="btn btn-info tombol" href="admin-price1.php"> Pricelist</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card" style="width: 17rem;">
            ...
            <div class="card-body">
              ...
              <a class="btn btn-info tombol" href="admin-price2.php"> Pricelist </a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="contactus" class="section-padding" style="background-color: #00000099;background-size:cover;">
    <div class="contact-form">
      <div class="container ">
        <div class="row contact-form-area justify-content-center wow fadeInUp">
